...
export const metadata: Metadata = {
  title: "SEO & Analytics | Services | Dark Media",
  description: "Data-driven SEO and Analytics services by Dark Media.",
};
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white font-sans text-[#111111]">
      ...
      <main className="w-full flex-grow pt-24 md:pt-28 pb-8 md:pb-12">
        <ServiceHero 
          badgeText="SEO & Analytics"
          titleLine1="More Than Just Traffic."
          titleLine2="Data-Driven Growth."
        />
        ...
        <section className="w-full px-4 sm:px-6 lg:px-8 pt-10 md:pt-20 pb-6 md:pb-10 max-w-[1400px] mx-auto">
          <div className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-medium leading-[1.3] text-[#11132d] max-w-6xl">
            <TextReveal delay={0.1}>
              Great SEO doesn't just bring people to your website—it brings the right people. At Dark Media, we combine deep technical optimization, strategic content, and advanced data analytics to dominate search rankings and drive highly-qualified traffic to your business.
            </TextReveal>
          </div>
        </section>
        ...
        <section className="w-full px-4 sm:px-6 lg:px-8 py-10 md:py-16 max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {[
             {
                title: "Technical SEO",
                desc: "We build a flawless foundation. From lightning-fast load speeds and mobile optimization to structured data and crawlability, we ensure search engines love your website.",
                icon: (
              ...
              },
              {
                ...
                desc: "We don't just guess keywords; we analyze intent. We craft high-quality, authoritative content that answers your audience's deepest questions and outranks the competition.",
                icon: (
                  <svg className="w-7 h-7 text-[#11132d] group-hover:text-white transition-colors duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              },
              {
                ...
                desc: "Data is meaningless without insight. We implement advanced tracking and custom dashboards so you always know exactly what's working, where traffic is coming from, and how to scale.",
                icon: (
                  <svg className="w-7 h-7 text-[#11132d] group-hover:text-white transition-colors duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="w-full px-4 sm:px-6 lg:px-8 py-16 md:py-24 max-w-[1400px] mx-auto">
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-24">
            ...
            <div className="lg:w-1/3">
              <div className="sticky top-32">
                ...
                <h3 className="text-3xl md:text-5xl font-bold tracking-tight text-gray-900 leading-[1.1] mb-6">
                  <SlideUpText delay={0.1}>SEO solutions <br className="hidden md:block"/> engineered for <span className="text-[#11132d]">growth.</span></SlideUpText>
                </h3>
                <p className="text-lg text-gray-600 font-medium leading-relaxed">
                  <SlideUpText delay={0.2}>We combine algorithmic expertise with cutting-edge analytics to build sustainable, long-term organic visibility that drives real business results.</SlideUpText>
                </p>
              </div>
            </div>
            ...
            <div className="lg:w-2/3 flex flex-col gap-4">
              {[
                { title: "Comprehensive SEO Audits", desc: "Uncover hidden technical issues and missed opportunities. We provide deep-dive audits that form the blueprint for your organic growth strategy." },
                { title: "On-Page & Off-Page Optimization", desc: "From meta tags and keyword density to building high-authority backlinks, we execute a holistic approach that signals trust and relevance to Google." },
                { title: "Local SEO & Google Business", desc: "Dominate your local market. We optimize your local listings and regional targeting so customers in your area find you first." },
                { title: "Custom Analytics & Reporting", desc: "Total transparency. We build custom Looker Studio and GA4 dashboards that tie organic traffic directly to leads and revenue." },
                { title: "Conversion Rate Optimization (CRO)", desc: "Traffic is only half the battle. We analyze user behavior to optimize your pages for maximum engagement and conversion." },
              ].map((offer, i) => (
