...
export const metadata: Metadata = {
  title: "Video Production | Services | Dark Media",
  description: "Cinematic Video Production services by Dark Media.",
};
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white font-sans text-[#111111]">
      ...
      <main className="w-full flex-grow pt-24 md:pt-28 pb-8 md:pb-12">
        <ServiceHero 
          badgeText="Premium Video Production"
          titleLine1="Stop the Scroll."
          titleLine2="Visuals That Command Attention."
        />
        ...
        <section className="w-full px-4 sm:px-6 lg:px-8 pt-10 md:pt-20 pb-6 md:pb-10 max-w-[1400px] mx-auto">
          <div className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-medium leading-[1.3] text-[#11132d] max-w-6xl">
            <TextReveal delay={0.1}>
              A great video does more than capture attention—it evokes emotion, builds trust, and compels your audience to take action. At Dark Media, we produce high-end, cinematic video content tailored to tell your unique brand story and drive measurable results.
            </TextReveal>
          </div>
        </section>
            ...
            {[
             {
                ...
                desc: "We don't just point and shoot. We collaborate with you to develop compelling scripts, storyboards, and creative directions that align perfectly with your marketing goals.",
                icon: (
                  <svg className="w-7 h-7 text-[#0f0f10] group-hover:text-white transition-colors duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              },
              {
                ...
                desc: "Our experienced crew uses industry-leading equipment, lighting, and techniques to capture stunning, high-quality footage that makes your brand look premium and professional.",
                icon: (
              ...
              },
              {
                ...
                desc: "The magic happens in the edit. From color grading and sound design to motion graphics and visual effects, we polish your video into a final masterpiece ready for any platform.",
                icon: (
                  <svg className="w-7 h-7 text-[#11132d] group-hover:text-white transition-colors duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="w-full px-4 sm:px-6 lg:px-8 py-16 md:py-24 max-w-[1400px] mx-auto">
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-24">
            ...
            <div className="lg:w-1/3">
              <div className="sticky top-32">
                ...
                <h3 className="text-3xl md:text-5xl font-bold tracking-tight text-gray-900 leading-[1.1] mb-6">
                  <SlideUpText delay={0.1}>Video solutions <br className="hidden md:block"/> engineered for <span className="text-[#11132d]">impact.</span></SlideUpText>
                </h3>
                <p className="text-lg text-gray-600 font-medium leading-relaxed">
                  <SlideUpText delay={0.2}>We combine creative storytelling with cutting-edge production techniques to build visual experiences that drive real, measurable business results.</SlideUpText>
                </p>
              </div>
            </div>
            ...
            <div className="lg:w-2/3 flex flex-col gap-4">
              {[
                { title: "Brand Films & Commercials", desc: "Make a powerful statement. We produce high-end brand anthems and commercials that capture the essence of your business and captivate your audience." },
                { title: "Corporate & Promotional Videos", desc: "Communicate your value clearly. We create engaging promotional content, company culture videos, and executive interviews that build trust and authority." },
                { title: "Social Media Content Creation", desc: "Stop the scroll. We produce bite-sized, highly engaging, and trend-focused video content optimized specifically for TikTok, Instagram Reels, and YouTube Shorts." },
                { title: "Product & Lifestyle Videos", desc: "Showcase your offerings in the best light. We create dynamic product videos and lifestyle shoots that highlight features and drive e-commerce sales." },
                { title: "Event Coverage & Highlights", desc: "Relive the moment. Our team provides comprehensive event coverage, capturing the energy of your activations, conferences, and launches to create thrilling highlight reels." },
              ].map((offer, i) => (
